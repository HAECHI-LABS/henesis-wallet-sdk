...
class EthWallet extends abstractWallet_1.EthLikeWallet {
    ...
    contractCall(contractAddress, value, data, passphrase, otpCode, gasPrice) {
        return super.contractCall(contractAddress, value, data, passphrase, otpCode, gasPrice);
    }
    transfer(coin, to, amount, passphrase, otpCode, gasPrice) {
    ...
    async flush(flushTargets, gasPrice, gasLimit) {
        const request = {
...
class EthMasterWallet extends abstractWallet_1.EthLikeWallet {
    ...
    async flush(coin, userWalletIds, passphrase, otpCode, gasPrice, gasLimit) {
        ...
        return this.sendTransaction(this.signPayload(multiSigPayload, passphrase), this.getId(), otpCode, gasPrice, gasLimit || this.DEFAULT_CONTRACT_CALL_GAS_LIMIT);
    }
    async approve(params) {
        const wallet = params.userWalletId
