...
export declare class EthWallet extends EthLikeWallet {
    ...
    contractCall(contractAddress: string, value: BN, data: string, passphrase: string, otpCode?: string, gasPrice?: BN): Promise<EthTransaction>;
    transfer(coin: string | Coin, to: string, amount: BN, passphrase: string, otpCode?: string, gasPrice?: BN): Promise<EthTransaction>;
    ...
    }>, gasPrice?: BN, gasLimit?: BN): Promise<EthTransaction>;
...
export declare class EthMasterWallet extends EthLikeWallet {
    ...
    getId(): string;
    changeName(name: string): Promise<void>;
    flush(coin: string | Coin, userWalletIds: string[], passphrase: string, otpCode?: string, gasPrice?: BN, gasLimit?: BN): Promise<EthTransaction>;
    approve(params: EthWithdrawalApproveParams): Promise<EthTransaction>;
    reject(params: {
        id: string;
        otpCode: string;
