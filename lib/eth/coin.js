...
exports.BscBnb = exports.Klay = exports.Eth = exports.NonStandardReturnTypeErc20 = exports.StandardErc20 = exports.Coin = exports.AttributesEnum = void 0;
...
class BscBnb extends Coin {
    ...
    async buildTransferMultiSigPayload(wallet, to, amount) {
        return Object.assign(Object.assign({}, (await this.buildTransferMultiSigPayloadTemplate(wallet))), { hexData: this.walletContract.methods.transferBnb(to, amount).encodeABI(), toAddress: wallet.getAddress() });
    }
    buildFlushData(wallet, targetAddresses) {
