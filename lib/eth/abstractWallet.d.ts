...
import { NftBalanceDTO, NftBalanceSearchCondition, SignedMultiSigPayloadDTO, TransactionDTO } from "../__generate__/eth";
...
export interface NftBalancePaginationOptions extends PaginationOptions, NftBalanceSearchCondition {
}
...
export declare abstract class EthLikeWallet extends Wallet<EthTransaction> {
    ...
    abstract sendNftTransaction(signedMultiSigPayload: SignedMultiSigPayload, nft: Nft, tokenOnchainId: string, to: string, otpCode?: string, gasPrice?: BN, gasLimit?: BN, metadata?: string): Promise<EthTransaction>;
}
