...
export declare class BtcMasterWallet extends Wallet<BtcTransaction> {
    ...
    build(to: string, amount: BN, passphrase: string, feeRate?: BN): Promise<BtcSignedRawTransaction>;
    transfer(to: string, amount: BN, passphrase: string, otpCode?: string, feeRate?: BN): Promise<Transfer>;
    sendSignedTransaction(signedRawTransactionRequest: BtcSignedRawTransactionRequest): Promise<Transfer>;
    createRawTransaction(to: string, amount: BN, feeRate?: BN): Promise<BtcRawTransaction>;
