...
exports.OperationControllerApiAxiosParamCreator = function (configuration) {
    return {
        approveCoinListingRequest: async (organizationId, requestId, approveCoinListingRequestRequest, options = {}) => {
            if (organizationId === null || organizationId === undefined) {
                throw new base_1.RequiredError('organizationId', 'Required parameter organizationId was null or undefined when calling approveCoinListingRequest.');
            }
        ...
        rejectCoinListingRequest: async (organizationId, requestId, rejectCoinListingRequestRequest, options = {}) => {
            if (organizationId === null || organizationId === undefined) {
                throw new base_1.RequiredError('organizationId', 'Required parameter organizationId was null or undefined when calling rejectCoinListingRequest.');
            }
            if (requestId === null || requestId === undefined) {
...
exports.OperationControllerApiFp = function (configuration) {
    return {
        async approveCoinListingRequest(organizationId, requestId, approveCoinListingRequestRequest, options) {
            const localVarAxiosArgs = await exports.OperationControllerApiAxiosParamCreator(configuration).approveCoinListingRequest(organizationId, requestId, approveCoinListingRequestRequest, options);
            return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
                return axios.request(axiosRequestArgs);
            };
        ...
        async rejectCoinListingRequest(organizationId, requestId, rejectCoinListingRequestRequest, options) {
            const localVarAxiosArgs = await exports.OperationControllerApiAxiosParamCreator(configuration).rejectCoinListingRequest(organizationId, requestId, rejectCoinListingRequestRequest, options);
            return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
                return axios.request(axiosRequestArgs);
            };
...
exports.OperationControllerApiFactory = function (configuration, basePath, axios) {
    return {
        approveCoinListingRequest(organizationId, requestId, approveCoinListingRequestRequest, options) {
            return exports.OperationControllerApiFp(configuration).approveCoinListingRequest(organizationId, requestId, approveCoinListingRequestRequest, options).then((request) => request(axios, basePath));
        },
        ...
        rejectCoinListingRequest(organizationId, requestId, rejectCoinListingRequestRequest, options) {
            return exports.OperationControllerApiFp(configuration).rejectCoinListingRequest(organizationId, requestId, rejectCoinListingRequestRequest, options).then((request) => request(axios, basePath));
        },
    };
};
class OperationControllerApi extends base_1.BaseAPI {
    approveCoinListingRequest(organizationId, requestId, approveCoinListingRequestRequest, options) {
        return exports.OperationControllerApiFp(this.configuration).approveCoinListingRequest(organizationId, requestId, approveCoinListingRequestRequest, options).then((request) => request(this.axios, this.basePath));
    }
    getAccount(accountId, options) {
    ...
    rejectCoinListingRequest(organizationId, requestId, rejectCoinListingRequestRequest, options) {
        return exports.OperationControllerApiFp(this.configuration).rejectCoinListingRequest(organizationId, requestId, rejectCoinListingRequestRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
