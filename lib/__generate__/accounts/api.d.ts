...
export declare const OperationControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    approveCoinListingRequest: (organizationId: string, requestId: string, approveCoinListingRequestRequest: ApproveCoinListingRequestRequest, options?: any) => Promise<RequestArgs>;
    ...
    rejectCoinListingRequest: (organizationId: string, requestId: string, rejectCoinListingRequestRequest: RejectCoinListingRequestRequest, options?: any) => Promise<RequestArgs>;
};
export declare const OperationControllerApiFp: (configuration?: Configuration) => {
    approveCoinListingRequest(organizationId: string, requestId: string, approveCoinListingRequestRequest: ApproveCoinListingRequestRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    ...
    rejectCoinListingRequest(organizationId: string, requestId: string, rejectCoinListingRequestRequest: RejectCoinListingRequestRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
...
export declare class OperationControllerApi extends BaseAPI {
    approveCoinListingRequest(organizationId: string, requestId: string, approveCoinListingRequestRequest: ApproveCoinListingRequestRequest, options?: any): Promise<import("axios").AxiosResponse<void>>;
    ...
    rejectCoinListingRequest(organizationId: string, requestId: string, rejectCoinListingRequestRequest: RejectCoinListingRequestRequest, options?: any): Promise<import("axios").AxiosResponse<void>>;
}
