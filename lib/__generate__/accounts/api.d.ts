...
export declare const OperationControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    activateOrganization: (organizationId: string, options?: any) => Promise<RequestArgs>;
    ...
    inactivateOrganization: (organizationId: string, options?: any) => Promise<RequestArgs>;
...
export declare const OperationControllerApiFp: (configuration?: Configuration) => {
    activateOrganization(organizationId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    ...
    inactivateOrganization(organizationId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
...
export declare class OperationControllerApi extends BaseAPI {
    activateOrganization(organizationId: string, options?: any): Promise<import("axios").AxiosResponse<void>>;
    ...
    inactivateOrganization(organizationId: string, options?: any): Promise<import("axios").AxiosResponse<void>>;
...
export declare const OrganizationControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    ...
    getCoinContract: (blockchain: 'ETHEREUM' | 'KLAYTN' | 'BITCOIN' | 'FILECOIN' | 'BINANCE_SMART_CHAIN' | 'LITECOIN' | 'BITCOIN_CASH', address: string, options?: any) => Promise<RequestArgs>;
...
export declare const OrganizationControllerApiFp: (configuration?: Configuration) => {
    ...
    getCoinContract(blockchain: 'ETHEREUM' | 'KLAYTN' | 'BITCOIN' | 'FILECOIN' | 'BINANCE_SMART_CHAIN' | 'LITECOIN' | 'BITCOIN_CASH', address: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoinContractDTO>>;
...
export declare class OrganizationControllerApi extends BaseAPI {
    ...
    getCoinContract(blockchain: 'ETHEREUM' | 'KLAYTN' | 'BITCOIN' | 'FILECOIN' | 'BINANCE_SMART_CHAIN' | 'LITECOIN' | 'BITCOIN_CASH', address: string, options?: any): Promise<import("axios").AxiosResponse<CoinContractDTO>>;
