...
export declare const AdminControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    getDepositAddresses5: (pageable: Pageable, condition: WalletSearchCondition, options?: any) => Promise<RequestArgs>;
    getExternalWithdrawals2: (pageable: Pageable, condition: ExternalWithdrawalSearchCondition, options?: any) => Promise<RequestArgs>;
    getMasterWallets5: (pageable: Pageable, condition: WalletSearchCondition, options?: any) => Promise<RequestArgs>;
    getTransfers8: (pageable: Pageable, condition: TransferSearchCondition, options?: any) => Promise<RequestArgs>;
};
export declare const AdminControllerApiFp: (configuration?: Configuration) => {
    getDepositAddresses5(pageable: Pageable, condition: WalletSearchCondition, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationWalletDTO>>;
    getExternalWithdrawals2(pageable: Pageable, condition: ExternalWithdrawalSearchCondition, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationSimplifiedTransferDTO>>;
    getMasterWallets5(pageable: Pageable, condition: WalletSearchCondition, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationWalletDTO>>;
    getTransfers8(pageable: Pageable, condition: TransferSearchCondition, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationSimplifiedTransferDTO>>;
};
export declare const AdminControllerApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    ...
    getExternalWithdrawals2(pageable: Pageable, condition: ExternalWithdrawalSearchCondition, options?: any): AxiosPromise<PaginationSimplifiedTransferDTO>;
...
export declare class AdminControllerApi extends BaseAPI {
    getDepositAddresses5(pageable: Pageable, condition: WalletSearchCondition, options?: any): Promise<import("axios").AxiosResponse<PaginationWalletDTO>>;
    getExternalWithdrawals2(pageable: Pageable, condition: ExternalWithdrawalSearchCondition, options?: any): Promise<import("axios").AxiosResponse<PaginationSimplifiedTransferDTO>>;
    getMasterWallets5(pageable: Pageable, condition: WalletSearchCondition, options?: any): Promise<import("axios").AxiosResponse<PaginationWalletDTO>>;
    getTransfers8(pageable: Pageable, condition: TransferSearchCondition, options?: any): Promise<import("axios").AxiosResponse<PaginationSimplifiedTransferDTO>>;
}
export declare const BchAdminControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    ...
    getTransfers4: (pageable: Pageable, condition: TransferSearchCondition, options?: any) => Promise<RequestArgs>;
};
export declare const BchAdminControllerApiFp: (configuration?: Configuration) => {
    ...
    getTransfers4(pageable: Pageable, condition: TransferSearchCondition, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationSimplifiedTransferDTO>>;
};
export declare const BchAdminControllerApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    ...
    getTransfers4(pageable: Pageable, condition: TransferSearchCondition, options?: any): AxiosPromise<PaginationSimplifiedTransferDTO>;
};
export declare class BchAdminControllerApi extends BaseAPI {
    ...
    getTransfers4(pageable: Pageable, condition: TransferSearchCondition, options?: any): Promise<import("axios").AxiosResponse<PaginationSimplifiedTransferDTO>>;
}
export declare const BchInternalControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    getTransfer2: (transferId: string, options?: any) => Promise<RequestArgs>;
    getTransfers3: (pageable: Pageable, specs: object, options?: any) => Promise<RequestArgs>;
};
export declare const BchInternalControllerApiFp: (configuration?: Configuration) => {
    getTransfer2(transferId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransferInternalDTO>>;
    getTransfers3(pageable: Pageable, specs: object, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationTransferInternalDTO>>;
};
export declare const BchInternalControllerApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    getTransfer2(transferId: string, options?: any): AxiosPromise<TransferInternalDTO>;
    getTransfers3(pageable: Pageable, specs: object, options?: any): AxiosPromise<PaginationTransferInternalDTO>;
};
export declare class BchInternalControllerApi extends BaseAPI {
    getTransfer2(transferId: string, options?: any): Promise<import("axios").AxiosResponse<TransferInternalDTO>>;
    getTransfers3(pageable: Pageable, specs: object, options?: any): Promise<import("axios").AxiosResponse<PaginationTransferInternalDTO>>;
}
export declare const BchTransferControllerApiAxiosParamCreator: (configuration?: Configuration) => {
...
export declare const BchTransferControllerApiFp: (configuration?: Configuration) => {
...
export declare const BchTransferControllerApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
...
export declare class BchTransferControllerApi extends BaseAPI {
...
export declare const BchWalletControllerApiAxiosParamCreator: (configuration?: Configuration) => {
...
export declare const BchWalletControllerApiFp: (configuration?: Configuration) => {
...
export declare const BchWalletControllerApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
...
export declare class BchWalletControllerApi extends BaseAPI {
...
export declare const BchWithdrawalApprovalControllerApiAxiosParamCreator: (configuration?: Configuration) => {
...
export declare const BchWithdrawalApprovalControllerApiFp: (configuration?: Configuration) => {
...
export declare const BchWithdrawalApprovalControllerApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
...
export declare class BchWithdrawalApprovalControllerApi extends BaseAPI {
...
export declare const InternalControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    getTransfer5: (transferId: string, options?: any) => Promise<RequestArgs>;
    getTransfers7: (pageable: Pageable, specs: object, options?: any) => Promise<RequestArgs>;
};
export declare const InternalControllerApiFp: (configuration?: Configuration) => {
    getTransfer5(transferId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransferInternalDTO>>;
    getTransfers7(pageable: Pageable, specs: object, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationTransferInternalDTO>>;
};
...
export declare class InternalControllerApi extends BaseAPI {
    getTransfer5(transferId: string, options?: any): Promise<import("axios").AxiosResponse<TransferInternalDTO>>;
    getTransfers7(pageable: Pageable, specs: object, options?: any): Promise<import("axios").AxiosResponse<PaginationTransferInternalDTO>>;
}
...
export declare const TransferControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    getTransfer4: (transferId: string, options?: any) => Promise<RequestArgs>;
    getTransfers6: (pageable: Pageable, specs: object, options?: any) => Promise<RequestArgs>;
};
export declare const TransferControllerApiFp: (configuration?: Configuration) => {
    getTransfer4(transferId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransferDTO>>;
    getTransfers6(pageable: Pageable, specs: object, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationTransferDTO>>;
};
...
export declare class TransferControllerApi extends BaseAPI {
    getTransfer4(transferId: string, options?: any): Promise<import("axios").AxiosResponse<TransferDTO>>;
    getTransfers6(pageable: Pageable, specs: object, options?: any): Promise<import("axios").AxiosResponse<PaginationTransferDTO>>;
}
export declare const WalletControllerApiAxiosParamCreator: (configuration?: Configuration) => {
    ...
    calculateEstimatedFee2: (walletId: string, options?: any) => Promise<RequestArgs>;
    ...
    createDepositAddress2: (walletId: string, createDepositAddressRequest: CreateDepositAddressRequest, options?: any) => Promise<RequestArgs>;
    createMasterWallet3: (createInactiveMasterWalletRequest: CreateInactiveMasterWalletRequest, options?: any) => Promise<RequestArgs>;
    createRawTransaction2: (walletId: string, createRawTransactionRequest: CreateRawTransactionRequest, options?: any) => Promise<RequestArgs>;
    ...
    getAllowedAddresses2: (walletId: string, pageable: Pageable, options?: any) => Promise<RequestArgs>;
    getBalance2: (walletId: string, options?: any) => Promise<RequestArgs>;
    getDepositAddress2: (walletId: string, depositAddressId: string, options?: any) => Promise<RequestArgs>;
    getDepositAddresses4: (walletId: string, pageable: Pageable, condition: WalletSearchCondition, options?: any) => Promise<RequestArgs>;
    ...
    getMasterWallets4: (specs: object, options?: any) => Promise<RequestArgs>;
    getWalletWithdrawalPolicies2: (walletId: string, pageable: Pageable, specs: object, options?: any) => Promise<RequestArgs>;
    getWalletWithdrawalPolicy2: (walletId: string, withdrawalPolicyId: string, options?: any) => Promise<RequestArgs>;
    ...
    patchMasterWalletAccountKey2: (walletId: string, patchAccountKeyRequest: PatchAccountKeyRequest, options?: any) => Promise<RequestArgs>;
    patchMasterWalletName2: (walletId: string, patchWalletNameRequest: PatchWalletNameRequest, options?: any) => Promise<RequestArgs>;
    patchWalletWithdrawalPolicy2: (walletId: string, withdrawalPolicyId: string, patchWithdrawalPolicyRequest: PatchWithdrawalPolicyRequest, options?: any) => Promise<RequestArgs>;
    sendTransaction2: (walletId: string, createTransactionRequest: CreateTransactionRequest, options?: any) => Promise<RequestArgs>;
...
export declare const WalletControllerApiFp: (configuration?: Configuration) => {
    ...
    calculateEstimatedFee2(walletId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EstimatedFeeDTO>>;
    ...
    createDepositAddress2(walletId: string, createDepositAddressRequest: CreateDepositAddressRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DepositAddressDTO>>;
    createMasterWallet3(createInactiveMasterWalletRequest: CreateInactiveMasterWalletRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateInactiveMasterWalletResponse | MasterWalletDTO>>;
    createRawTransaction2(walletId: string, createRawTransactionRequest: CreateRawTransactionRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RawTransactionDTO>>;
    ...
    getAllowedAddresses2(walletId: string, pageable: Pageable, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationAllowedAddressDTO>>;
    getBalance2(walletId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BalanceDTO>>;
    getDepositAddress2(walletId: string, depositAddressId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DepositAddressDTO>>;
    getDepositAddresses4(walletId: string, pageable: Pageable, condition: WalletSearchCondition, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationDepositAddressDTO>>;
    ...
    getMasterWallets4(specs: object, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<MasterWalletDTO>>>;
    getWalletWithdrawalPolicies2(walletId: string, pageable: Pageable, specs: object, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationWalletWithdrawalPolicyDTO>>;
    getWalletWithdrawalPolicy2(walletId: string, withdrawalPolicyId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WalletWithdrawalPolicyDTO>>;
    ...
    patchMasterWalletAccountKey2(walletId: string, patchAccountKeyRequest: PatchAccountKeyRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<KeyDTO>>;
    patchMasterWalletName2(walletId: string, patchWalletNameRequest: PatchWalletNameRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MasterWalletDTO>>;
    patchWalletWithdrawalPolicy2(walletId: string, withdrawalPolicyId: string, patchWithdrawalPolicyRequest: PatchWithdrawalPolicyRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WalletWithdrawalPolicyDTO>>;
    sendTransaction2(walletId: string, createTransactionRequest: CreateTransactionRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransferDTO>>;
...
export declare class WalletControllerApi extends BaseAPI {
    ...
    calculateEstimatedFee2(walletId: string, options?: any): Promise<import("axios").AxiosResponse<EstimatedFeeDTO>>;
    ...
    createDepositAddress2(walletId: string, createDepositAddressRequest: CreateDepositAddressRequest, options?: any): Promise<import("axios").AxiosResponse<DepositAddressDTO>>;
    createMasterWallet3(createInactiveMasterWalletRequest: CreateInactiveMasterWalletRequest, options?: any): Promise<import("axios").AxiosResponse<CreateInactiveMasterWalletResponse | MasterWalletDTO>>;
    createRawTransaction2(walletId: string, createRawTransactionRequest: CreateRawTransactionRequest, options?: any): Promise<import("axios").AxiosResponse<RawTransactionDTO>>;
    ...
    getAllowedAddresses2(walletId: string, pageable: Pageable, options?: any): Promise<import("axios").AxiosResponse<PaginationAllowedAddressDTO>>;
    getBalance2(walletId: string, options?: any): Promise<import("axios").AxiosResponse<BalanceDTO>>;
    getDepositAddress2(walletId: string, depositAddressId: string, options?: any): Promise<import("axios").AxiosResponse<DepositAddressDTO>>;
    getDepositAddresses4(walletId: string, pageable: Pageable, condition: WalletSearchCondition, options?: any): Promise<import("axios").AxiosResponse<PaginationDepositAddressDTO>>;
    ...
    getMasterWallets4(specs: object, options?: any): Promise<import("axios").AxiosResponse<MasterWalletDTO[]>>;
    getWalletWithdrawalPolicies2(walletId: string, pageable: Pageable, specs: object, options?: any): Promise<import("axios").AxiosResponse<PaginationWalletWithdrawalPolicyDTO>>;
    getWalletWithdrawalPolicy2(walletId: string, withdrawalPolicyId: string, options?: any): Promise<import("axios").AxiosResponse<WalletWithdrawalPolicyDTO>>;
    ...
    patchMasterWalletAccountKey2(walletId: string, patchAccountKeyRequest: PatchAccountKeyRequest, options?: any): Promise<import("axios").AxiosResponse<KeyDTO>>;
    patchMasterWalletName2(walletId: string, patchWalletNameRequest: PatchWalletNameRequest, options?: any): Promise<import("axios").AxiosResponse<MasterWalletDTO>>;
    patchWalletWithdrawalPolicy2(walletId: string, withdrawalPolicyId: string, patchWithdrawalPolicyRequest: PatchWithdrawalPolicyRequest, options?: any): Promise<import("axios").AxiosResponse<WalletWithdrawalPolicyDTO>>;
    sendTransaction2(walletId: string, createTransactionRequest: CreateTransactionRequest, options?: any): Promise<import("axios").AxiosResponse<TransferDTO>>;
...
export declare const WithdrawalApprovalControllerApiFp: (configuration?: Configuration) => {
    approveWithdrawalApproval2(withdrawalApprovalId: string, approveWithdrawalApprovalRequest: ApproveWithdrawalApprovalRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransferDTO>>;
...
export declare class WithdrawalApprovalControllerApi extends BaseAPI {
    approveWithdrawalApproval2(withdrawalApprovalId: string, approveWithdrawalApprovalRequest: ApproveWithdrawalApprovalRequest, options?: any): Promise<import("axios").AxiosResponse<TransferDTO>>;
