...
exports.WalletControllerApiAxiosParamCreator = function (configuration) {
    return {
        ...
        getFlushes: async (masterWalletId, pageable, options = {}) => {
            if (masterWalletId === null || masterWalletId === undefined) {
                throw new base_1.RequiredError('masterWalletId', 'Required parameter masterWalletId was null or undefined when calling getFlushes.');
            }
            if (pageable === null || pageable === undefined) {
...
exports.WalletControllerApiFp = function (configuration) {
    return {
        ...
        async getFlushes(masterWalletId, pageable, options) {
            const localVarAxiosArgs = await exports.WalletControllerApiAxiosParamCreator(configuration).getFlushes(masterWalletId, pageable, options);
            return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
                return axios.request(axiosRequestArgs);
            };
...
exports.WalletControllerApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        getFlushes(masterWalletId, pageable, options) {
            return exports.WalletControllerApiFp(configuration).getFlushes(masterWalletId, pageable, options).then((request) => request(axios, basePath));
        },
...
class WalletControllerApi extends base_1.BaseAPI {
    ...
    getFlushes(masterWalletId, pageable, options) {
        return exports.WalletControllerApiFp(this.configuration).getFlushes(masterWalletId, pageable, options).then((request) => request(this.axios, this.basePath));
    }
    getMasterWallet(masterWalletId, options) {
