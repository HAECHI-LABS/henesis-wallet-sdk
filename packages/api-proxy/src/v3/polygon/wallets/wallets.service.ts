...
export class WalletsService {
  public async getMasterWallets(
    ...
    return (await sdk.polygon.wallets.getMasterWallets(options)).map((c) =>
      c.getData()
    );
  }
  ...
  public async getMasterWallet(
    ...
    return (
      await sdk.polygon.wallets.getMasterWallet(masterWalletId)
    ).getData();
  }
  ...
  private static async getMasterWalletById(
    ...
    return await sdk.polygon.wallets.getMasterWallet(id);
  }
  ...
  private static getCoinByTicker(sdk: SDK, ticker: string): Promise<Coin> {
    return sdk.polygon.coins.getCoin(ticker);
  }
  ...
  public async transferNft(
    ...
    const wallet = await sdk.polygon.wallets.getMasterWallet(walletId);
    return TransactionDTO.fromEthTransaction(
  ...
  public async transferUserWalletNft(
    ...
    const wallet = await sdk.polygon.wallets.getMasterWallet(masterWalletId);
  ...
  public async getUserWalletNftBalance(
    ...
    const masterWallet = await sdk.polygon.wallets.getMasterWallet(
      masterWalletId
    );
  ...
  public async getNftTransfers(
    ...
    const result: Pagination<EthNftTransferEvent> =
      await sdk.polygon.events.getNftTransferEvents(
