...
export const EXAMPLE_POLYGON_FLUSH_TARGET_DTO: Target = {
  coinId: 11,
  userWalletId: "c2bd6506cb56a6baaff32653ac77ef49",
};

export const EXAMPLE_POLYGON_CREATE_FLUSH_REQUEST_DTO: CreateFlushRequestDTO = {
  targets: [EXAMPLE_POLYGON_FLUSH_TARGET_DTO],
  gasPrice: "8000000000",
  gasLimit: "10000000000",
  metadata: "metadata",
};

export const EXAMPLE_POLYGON_NFT_FLUSH_TARGET_DTO: NftTarget = {
  nftId: 11,
  userWalletId: "c2bd6506cb56a6baaff32653ac77ef49",
};
...
class Target {
  @ApiModelProperty({
    ...
    example: EXAMPLE_POLYGON_FLUSH_TARGET_DTO.coinId,
  })
  coinId: number;

  @ApiModelProperty({
    description: "사용자 지갑 ID",
    example: EXAMPLE_POLYGON_FLUSH_TARGET_DTO.userWalletId,
  })
  userWalletId: string;
}
...
export class CreateFlushRequestDTO {
  ...
  @ApiModelPropertyOptional({
    ...
    example: EXAMPLE_POLYGON_CREATE_FLUSH_REQUEST_DTO.gasPrice,
  })
  gasPrice?: string;
  ...
  @ApiModelPropertyOptional({
    ...
    example: EXAMPLE_POLYGON_CREATE_FLUSH_REQUEST_DTO.gasLimit,
  })
  gasLimit?: string;
...
class NftTarget {
  @ApiModelProperty({
    ...
    example: EXAMPLE_POLYGON_NFT_FLUSH_TARGET_DTO.nftId,
  })
  nftId: number;
