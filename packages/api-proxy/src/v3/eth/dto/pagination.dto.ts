...
import {
  ...
  EXAMPLE_POLYGON_NFT_TRANSFER_DTO,
  NftTransferDTO,
...
export const EXAMPLE_POLYGON_PAGINATION_NFT_TRANSFER_DTO: PaginationDTO<NftTransferDTO> =
  {
    pagination: EXAMPLE_ETHEREUM_PAGINATION_METADATA,
    results: [EXAMPLE_POLYGON_NFT_TRANSFER_DTO],
  };
