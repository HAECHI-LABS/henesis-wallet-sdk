...
export const EXAMPLE_ETHEREUM_KEY_DTO: KeyDTO = {
...
export class KeyDTO {
  @ApiModelPropertyOptional({
    description: "",
    example: EXAMPLE_ETHEREUM_KEY_DTO.address,
  })
  address?: string;

  @ApiModelProperty({
    description: "pub",
    example: EXAMPLE_ETHEREUM_KEY_DTO.pub,
  })
  pub: string;

  @ApiModelPropertyOptional({
    description: "feeDelegationEnabled",
    example: EXAMPLE_ETHEREUM_KEY_DTO.feeDelegationEnabled,
  })
  feeDelegationEnabled?: boolean;

  @ApiModelPropertyOptional({
    description: "keyFile",
    example: EXAMPLE_ETHEREUM_KEY_DTO.keyFile,
  })
  keyFile?: string;

  @ApiModelPropertyOptional({
    description: "keyId",
    example: EXAMPLE_ETHEREUM_KEY_DTO.keyId,
  })
  keyId?: string;
}
