...
import {
  ...
  NAME_OPTIONAL, NFT_ID_OPTIONAL,
  PAGE_OPTIONAL,
  SIZE_OPTIONAL, STATUS_OPTIONAL,
  TICKER_OPTIONAL, TOKEN_NAME_OPTIONAL, TOKEN_ONCHAIN_ID_OPTIONAL, TRANSACTION_HASH_OPTIONAL, TRANSACTION_ID_OPTIONAL,
  TRANSACTION_ID_REQUIRED, TRANSFER_TYPE_OPTIONAL, UPDATED_AT_GTE_OPTIONAL, UPDATED_AT_LE_OPTIONAL, WALLET_ID_OPTIONAL,
  WALLET_ID_REQUIRED,
} from "../dto/params";
import express from "express";
import {
  DepositAddressNotFoundException,
  EXAMPLE_DEPOSIT_ADDRESS_NOT_FOUND_EXCEPTION_DTO, EXAMPLE_INVALID_STATUS_EXCEPTION_DTO,
