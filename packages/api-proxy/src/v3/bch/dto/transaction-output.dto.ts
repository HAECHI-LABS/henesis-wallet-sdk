...
import { BchTransactionOutput } from "@haechi-labs/henesis-wallet-core/lib/bch/wallet";
...
export class TransactionOutputDto {
  ...
  @ApiModelProperty({
    description: "Output에 포함된 암호화폐의 양 (단위: satoshi) (형식: 10진법)",
