...
export const EXAMPLE_LITECOIN_PAGINATION_METADATA_DTO: PaginationMetadata = {
...
export const EXAMPLE_LITECOIN_PAGINATION_DEPOSIT_ADDRESS_DTO: PaginationDTO<DepositAddressDTO> =
  {
    pagination: EXAMPLE_LITECOIN_PAGINATION_METADATA_DTO,
    results: [EXAMPLE_LITECOIN_DEPOSIT_ADDRESS_DTO],
  };
...
export const EXAMPLE_LITECOIN_PAGINATION_TRANSFER_DTO: PaginationDTO<TransferDTO> =
  {
    pagination: EXAMPLE_LITECOIN_PAGINATION_METADATA_DTO,
    results: [EXAMPLE_LITECOIN_TRANSFER_DTO],
  };
