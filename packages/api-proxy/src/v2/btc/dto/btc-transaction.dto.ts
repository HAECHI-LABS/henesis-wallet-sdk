import {
  ...
  EXAMPLE_LITECOIN_BTC_TRANSACTION_OUTPUT_DTO,
...
export const EXAMPLE_LITECOIN_BTC_TRANSACTION_DTO: BtcTransactionDTO = {
  ...EXAMPLE_BITCOIN_BTC_TRANSACTION_DTO,
  transactionHash:
    "612f7cf11aeec9441a8758781b5549fc720500023f663e118b14ee2b712d216c",
  outputs: [EXAMPLE_LITECOIN_BTC_TRANSACTION_OUTPUT_DTO],
};
