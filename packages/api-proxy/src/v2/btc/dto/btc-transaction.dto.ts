import { BtcTransactionOutputDTO, EXAMPLE_BITCOIN_BTC_TRANSACTION_OUTPUT_DTO } from './btc-transaction-output.dto';
...
export const EXAMPLE_BITCOIN_BTC_TRANSACTION_DTO: BtcTransactionDTO = {
  ...
  transactionHash: "beb70cf0b90afb6683ece78e0dfb4a140cf498310b833eea8092b5edd271e9c3",
...
export class BtcTransactionDTO {
  @ApiModelProperty({
    description: "트랜잭션 ID (Henesis Wallet에서 부여하는 트랜잭션의 고유 ID입니다. 온체인 트랜잭션 해시와 다른 개념입니다.)",
  ...
  @ApiModelProperty({
    description: "트랜잭션이 담긴 블록 번호 (형식: 16진법) (트랜잭션 상태가 PENDING일 때는 존재하지 않습니다.)",
