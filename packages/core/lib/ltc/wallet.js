...
exports.LtcMasterWallet = exports.transformWalletData = void 0;
...
class LtcMasterWallet extends wallet_1.Wallet {
    ...
    async changeName(name) {
        ...
        const ltcWalletData = await this.client.patch(`${this.baseUrl}/name`, request);
...
exports.LtcMasterWallet = LtcMasterWallet;
