 ...
 * 
 * @export
 * @interface ApproveCoinListingRequestRequest
 */
 ...
 * 
 * @export
 * @interface CoinListingRequestDTO
 */
 ...
 * 
 * @export
 * @interface CreateCoinListingRequestRequest
 */
 ...
 * 
 * @export
 * @interface RejectCoinListingRequestRequest
 */
...
export const NoticeControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getNotices: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v2/notices`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
         ...
         * 
         * @param {string} noticeId 
         * @param {UpdateNoticeRequest} updateNoticeRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateNotice: async (noticeId: string, updateNoticeRequest: UpdateNoticeRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'noticeId' is not null or undefined
            if (noticeId === null || noticeId === undefined) {
                throw new RequiredError('noticeId','Required parameter noticeId was null or undefined when calling updateNotice.');
            }
            // verify required parameter 'updateNoticeRequest' is not null or undefined
...
export const NoticeControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getNotices(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<NoticeDTO>>> {
            const localVarAxiosArgs = await NoticeControllerApiAxiosParamCreator(configuration).getNotices(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updateNotice(noticeId: string, updateNoticeRequest: UpdateNoticeRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await NoticeControllerApiAxiosParamCreator(configuration).updateNotice(noticeId, updateNoticeRequest, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const NoticeControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getNotices(options?: any): AxiosPromise<Array<NoticeDTO>> {
            return NoticeControllerApiFp(configuration).getNotices(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} noticeId 
...
export class NoticeControllerApi extends BaseAPI {
    ...
    public getNotices(options?: any) {
        return NoticeControllerApiFp(this.configuration).getNotices(options).then((request) => request(this.axios, this.basePath));
    }
...
export const OperationControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        approveCoinListingRequest: async (requestId: string, approveCoinListingRequestRequest: ApproveCoinListingRequestRequest, options: any = {}): Promise<RequestArgs> => {
            ...
            // verify required parameter 'approveCoinListingRequestRequest' is not null or undefined
        ...
        rejectCoinListingRequest: async (requestId: string, rejectCoinListingRequestRequest: RejectCoinListingRequestRequest, options: any = {}): Promise<RequestArgs> => {
            ...
            // verify required parameter 'rejectCoinListingRequestRequest' is not null or undefined
...
export const OrganizationControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cancelCoinListingRequest: async (requestId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'requestId' is not null or undefined
            if (requestId === null || requestId === undefined) {
                throw new RequiredError('requestId','Required parameter requestId was null or undefined when calling cancelCoinListingRequest.');
            }
        ...
        /**
         * 
         * @param {CreateCoinListingRequestRequest} createCoinListingRequestRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createCoinListingRequest: async (createCoinListingRequestRequest: CreateCoinListingRequestRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'createCoinListingRequestRequest' is not null or undefined
            if (createCoinListingRequestRequest === null || createCoinListingRequestRequest === undefined) {
                throw new RequiredError('createCoinListingRequestRequest','Required parameter createCoinListingRequestRequest was null or undefined when calling createCoinListingRequest.');
            }
        ...
        getCoinContract: async (blockchain: 'ETHEREUM' | 'KLAYTN' | 'BITCOIN' | 'FILECOIN' | 'BINANCE_SMART_CHAIN' | 'LITECOIN' | 'BITCOIN_CASH', address: string, options: any = {}): Promise<RequestArgs> => {
            ...
            if (address === null || address === undefined) {
                throw new RequiredError('address','Required parameter address was null or undefined when calling getCoinContract.');
            }
         ...
         * @throws {RequiredError}
         */
        getCoinListingRequests: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v2/organizations/coin-listing-requests`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        patchOrganization: async (orgId: string, createOrganizationRequest: CreateOrganizationRequest, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'orgId' is not null or undefined
            if (orgId === null || orgId === undefined) {
                throw new RequiredError('orgId','Required parameter orgId was null or undefined when calling patchOrganization.');
            }
            // verify required parameter 'createOrganizationRequest' is not null or undefined
            if (createOrganizationRequest === null || createOrganizationRequest === undefined) {
                throw new RequiredError('createOrganizationRequest','Required parameter createOrganizationRequest was null or undefined when calling patchOrganization.');
            }
            const localVarPath = `/api/v2/organizations/{orgId}`
...
export const OrganizationControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async cancelCoinListingRequest(requestId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await OrganizationControllerApiAxiosParamCreator(configuration).cancelCoinListingRequest(requestId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async createCoinListingRequest(createCoinListingRequestRequest: CreateCoinListingRequestRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoinListingRequestDTO>> {
            const localVarAxiosArgs = await OrganizationControllerApiAxiosParamCreator(configuration).createCoinListingRequest(createCoinListingRequestRequest, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async getCoinListingRequests(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CoinListingRequestDTO>>> {
            const localVarAxiosArgs = await OrganizationControllerApiAxiosParamCreator(configuration).getCoinListingRequests(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async patchOrganization(orgId: string, createOrganizationRequest: CreateOrganizationRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationDTO>> {
            const localVarAxiosArgs = await OrganizationControllerApiAxiosParamCreator(configuration).patchOrganization(orgId, createOrganizationRequest, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const OrganizationControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        cancelCoinListingRequest(requestId: string, options?: any): AxiosPromise<void> {
            return OrganizationControllerApiFp(configuration).cancelCoinListingRequest(requestId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {RequestActivationRequest} requestActivationRequest 
        ...
        createCoinListingRequest(createCoinListingRequestRequest: CreateCoinListingRequestRequest, options?: any): AxiosPromise<CoinListingRequestDTO> {
            return OrganizationControllerApiFp(configuration).createCoinListingRequest(createCoinListingRequestRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {CreateOrganizationRequest} createOrganizationRequest 
        ...
        getCoinListingRequests(options?: any): AxiosPromise<Array<CoinListingRequestDTO>> {
            return OrganizationControllerApiFp(configuration).getCoinListingRequests(options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {*} [options] Override http request option.
         ...
         * @throws {RequiredError}
         */
        patchOrganization(orgId: string, createOrganizationRequest: CreateOrganizationRequest, options?: any): AxiosPromise<OrganizationDTO> {
            return OrganizationControllerApiFp(configuration).patchOrganization(orgId, createOrganizationRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class OrganizationControllerApi extends BaseAPI {
     ...
     * @memberof OrganizationControllerApi
     */
    public createCoinListingRequest(createCoinListingRequestRequest: CreateCoinListingRequestRequest, options?: any) {
        return OrganizationControllerApiFp(this.configuration).createCoinListingRequest(createCoinListingRequestRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrganizationControllerApi
     */
    public getCoinListingRequests(options?: any) {
        return OrganizationControllerApiFp(this.configuration).getCoinListingRequests(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrganizationControllerApi
     */
    public patchOrganization(orgId: string, createOrganizationRequest: CreateOrganizationRequest, options?: any) {
        return OrganizationControllerApiFp(this.configuration).patchOrganization(orgId, createOrganizationRequest, options).then((request) => request(this.axios, this.basePath));
    }
