      ...
      const response = {
        ...
        signedMultiSigPayload: {
          ...
          payload: {
            ...
            walletNonce:
              '0x71bd58e13a6a128d0c76c02c04a9b1de964e99bab70a426366ebb9cedc857970',
            hexData:
        ...
        rawTransaction: {
          ...
          value: '0x0',
          data:
            '',
  ...
  describe('#getTransactions()', () => {
    it('should return valid transactions', async () => {
      ...
      const response = {
        pagination: {
          nextUrl:
            'http://localhost:8080/api/v1/transactions?blockchain=ETHEREUM?page=1?size=10',
          previousUrl: null,
          totalCount: 1,
        },
        results: [
      ...
      nock(baseUrl)
        .get(
          `/api/v1/transactions?size=${paginationOptions.size}&blockchain=${blockchain}`,
        )
        .reply(200, response);
      ...
      const transactionsWithPagination = await sdk.transactions.getTransactions(
        blockchain,
        paginationOptions,
      );
